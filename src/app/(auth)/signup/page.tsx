...
<button
                ...
                className="flex items-center justify-center gap-2 py-3 px-4 border border-zinc-300 dark:border-zinc-700 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition cursor-pointer"
              >
...
<button
          ...
          <p className="mt-8 text-center text-sm text-zinc-600 dark:text-zinc-400">
            이미 계정이 있으신가요?{' '}
            <Link href="/login" className="text-blue-600 hover:text-blue-500 font-medium transition cursor-pointer">
              로그인
            </Link>
          </p>
        </div>
